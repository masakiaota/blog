...
- どのようなときにバイアスは生じるのか
  - 測定系の丸め込みが違うとか
  - one-hotは必ず多重共線性が生じる
- 他の特徴量重要度の紹介 permutation importances https://blog.amedama.jp/entry/permutation-importance
...
-  判別問題に限定して話を進める
-  決定木の学習方法はわかった前提で話を進める（わかりやすい解説サイトを探そう） （https://qiita.com/3000manJPY/items/ef7495960f472ec14377 でいう不純度の差という概念が重要なので決定木の学習方法について詳しくない方は目を通して置きたい。）
-  
...
（実際に特徴量重要度の算出の仕方に不明な点が存在する）（あとで書き出してみよう）(完全に理解した)
...
この記事では人工データを生成しバイアスを再現してみた。また、こういったバイアスに対処できたという論文を見つけたので軽く紹介する。おまけとしてgainベース以外の特徴量重要度についても紹介する。
...
具体的な計算方法を図と数式を使って表すと以下の通り(scikit-learnの場合)
