...
ありがたいことに Kaggle RunPod 部の一員として一章書かせてもらえることになったので、布教のために過去コンペでの RunPod 活用例について紹介させていただくことにした。
...
今回も前回と同様にコンペ終了間際での解法選択だったため、贅沢に RTX 4090 が8台刺さったインスタンスを借りることにした。
